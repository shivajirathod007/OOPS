...
void login()
{
    ...
    cin >> n;
    cout << "\n\n\t\t\t|--------------LOGIN----------------|" << endl;
    cout << "\n\t\t\t Enter User_name for login: ";
    cin >> user;
    cout << "\n\t\t\t Enter Password for login: ";
    cin >> pass;
    cout << "\n\t\t\t|-----------------------------------|" << endl;
    if (n == pass && strcmp(name, user) == 0)
    {
        system("cls");
...
void menu()
{
    ...
    cout << "\n\n\t\tWelcome to shivaji's milk dairy [ " << user << " ]";
    ...
    while (opt != 5)
    {
        ...
        case 4:
            ...
            break;
        case 5:
            cout << "\n\t\t\tThank you | bad main mat code crash hojayege ";
            exit(0);
        default:
            break;
        }
...
void meal()
{
    ...
    cout << "\n\t\t ============================================";
    cout << "\n\t\t| 1.POOJA's Animal MEAL        - 0.1 rs      |";
    cout << "\n\t\t| 2.ABHI's Bhusa              - 1.0 rs       |";
    cout << "\n\t\t| 3.For growth in Milk-Products    - 3.50rs  |";
    cout << "\n\t\t ============================================";
...
{
    system("cls");
    cout << "\n\n\t\tAbout SHIVAJI's  milk dairy";
    cout << "\n\t\t ============================================";
    cout << "\n\t\t|  SHIVAJI's milk dairy is a leading dairy  |";
    cout << "\n\t\t|  in the region, providing quality dairy   |";
    cout << "\n\t\t|  products to our customers. We are        |";
    cout << "\n\t\t|  commited to delivring bad and unhalthy   |";
